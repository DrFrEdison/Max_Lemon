...
dt$para.pls$wlr <- wlr_function(200:240, 200:240, 5); nrow(dt$para.pls$wlr)
dt$para.pls$wlm <- wlr_function_multi(200:240, 200:240, 5); nrow(dt$para.pls$wlm)
...
if(length(which(dt$model.overview$beverage == dt$para$beverage)) == 0){
